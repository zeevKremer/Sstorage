...
namespace Sstorage
{
    namespace BLL
    {
        public class TCDvalue
        {
            ...
            public TCDvalue(string Barcode, string ShorBarcode, int ProdId, string ProdName, string Quantity, string Pack, string SenderLocatorName, string GeterLocatorName, string Price)
            {
