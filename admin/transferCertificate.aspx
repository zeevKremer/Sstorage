...
<title> העברות בין סניפים | Sstorage</title>
    ...
    .column7{
        ...
        <script>  
         ...
         function validationText() {
             sender = document.getElementById('<%= DdlStorageSender.ClientID %>').value.trim();
            ...
            <tr>
               ...
               <div>                
                חיפוש לפי               
                    ...
                    <asp:ListItem Text="סניף שולח" Value="3"></asp:ListItem>
                    <asp:ListItem Text="סניף מקבל" Value="4"></asp:ListItem>
                  ...
                  <br />
                   <table style="width:570px;" border="0">                             
                      ...
                      <tr>
                         ...
                         <td style="width:50%;background-color:#ffffff;">
                             <center>                                                                                                                                         
                                 <asp:DropDownList ID="DdlStorageSender" CssClass="ddl" onchange="validationText()" runat="server" />
                             </center>
                         </td> 
                      </tr>
                      <tr>
        ...
        <table style="width:1200px;">
          <thead>
            ...
            <tr class="table100-head" id="Certificate" style="display:normal;">
              ...
              <th class="column5" style="text-align:center;">סניף שולח</th>
            ...
            <asp:Repeater ID="Repeater1" runat="server">                
             ...
             <tr  >
              ...
              <td class="column7"><asp:LinkButton ID="BtnCertDetails" runat="server" OnClick="BtnCertDetails_Click"   CommandArgument='<%#Eval("CertificateId") %>'  ><i class='fa fa-edit'   style="font-size:16px;color:#0026ff;"></i>&nbsp;</asp:LinkButton></td>               
             </tr> 
                    <tr class="u">
                        <td></td>
                    </tr>                    
